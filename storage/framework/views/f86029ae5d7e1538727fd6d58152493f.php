...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <p class="text-center text-sm text-mountain-400 mt-6">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-trust-400 hover:underline">Login</a></p>
</div>
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\laragon\www\thesummit\resources\views/auth/register.blade.php ENDPATH**/ ?>