<?php $__env->startComponent('layouts.app', ['title' => 'The Summit']); ?>
<div class="max-w-2xl mx-auto px-4 py-16 text-center">
    <div class="mb-8">
        <svg class="w-20 h-20 mx-auto text-trust-400 mb-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 22h20L12 2z"/></svg>
        ...
        <p class="text-trust-400 text-sm mt-2 italic font-expedition">"The real winner is the one who makes everybody win."</p>
    </div>

    <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="w-full sm:w-auto px-8 py-3 rounded-xl bg-trust-500 text-mountain-950 font-bold text-lg hover:bg-trust-400">Ke Dashboard</a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
            <a href="<?php echo e(route('login')); ?>" class="w-full sm:w-auto px-8 py-3 rounded-xl bg-trust-500 text-mountain-950 font-bold text-lg hover:bg-trust-400">Mulai Pendakian</a>
            <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto px-8 py-3 rounded-xl border border-mountain-600 text-mountain-200 hover:bg-mountain-800">Buat Akun</a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
...
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\laragon\www\thesummit\resources\views/welcome.blade.php ENDPATH**/ ?>