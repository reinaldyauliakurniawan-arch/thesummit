...
onkeydown="if(event.key==='Enter'){event.preventDefault();document.getElementById('jf').action='/rooms/'+document.getElementById('jc').value.toUpperCase()+'/join';document.getElementById('jf').submit();}">
<button type="button" onclick="document.getElementById('jf').action='/rooms/'+document.getElementById('jc').value.toUpperCase()+'/join';document.getElementById('jf').submit();" class="px-4 py-2 rounded-xl bg-mountain-700 text-mountain-200 text-sm">Gabung</button></div></form></div></div>
